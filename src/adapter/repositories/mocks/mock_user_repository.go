...
func (_mock *MockUserRepository) FindByUsername(ctx context.Context, username string) (*models.User, error) {
...
func (_c *MockUserRepository_FindByUsername_Call) Return(user *models.User, err error) *MockUserRepository_FindByUsername_Call {
	_c.Call.Return(user, err)
	return _c
}

func (_c *MockUserRepository_FindByUsername_Call) RunAndReturn(run func(ctx context.Context, username string) (*models.User, error)) *MockUserRepository_FindByUsername_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateLastLoginAt provides a mock function for the type MockUserRepository
func (_mock *MockUserRepository) UpdateLastLoginAt(ctx context.Context, userID uint, lastLoginAt time.Time) error {
	ret := _mock.Called(ctx, userID, lastLoginAt)
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uint, time.Time) error); ok {
		r0 = returnFunc(ctx, userID, lastLoginAt)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
func (_e *MockUserRepository_Expecter) UpdateLastLoginAt(ctx any, userID any, lastLoginAt any) *MockUserRepository_UpdateLastLoginAt_Call {
	return &MockUserRepository_UpdateLastLoginAt_Call{Call: _e.mock.On("UpdateLastLoginAt", ctx, userID, lastLoginAt)}
}

func (_c *MockUserRepository_UpdateLastLoginAt_Call) Run(run func(ctx context.Context, userID uint, lastLoginAt time.Time)) *MockUserRepository_UpdateLastLoginAt_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockUserRepository_UpdateLastLoginAt_Call) RunAndReturn(run func(ctx context.Context, userID uint, lastLoginAt time.Time) error) *MockUserRepository_UpdateLastLoginAt_Call {
	_c.Call.Return(run)
	return _c
}
